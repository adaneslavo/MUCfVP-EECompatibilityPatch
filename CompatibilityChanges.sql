...
UPDATE Units SET Combat = '25' WHERE Type = 'UNIT_PORTUGUESE_CACADORES';
UPDATE Units SET RangedCombat = '38' WHERE Type = 'UNIT_PORTUGUESE_CACADORES';
...
UPDATE Units SET Combat = '23' WHERE Type = 'UNIT_GREECE_KLEPHT';
UPDATE Units SET RangedCombat = '38' WHERE Type = 'UNIT_GREECE_KLEPHT';
...
UPDATE Units SET Combat = '20' WHERE Type = 'UNIT_RUSSIA_LICORNE';
...
UPDATE Buildings SET IlliteracyHappinessChange = '-25' WHERE Type = 'BUILDING_FRANCE_GRANDE_ECOLE';
...
UPDATE Buildings SET HealRateChange = '0' WHERE Type = 'BUILDING_AUSTRIA_STANDSCHUTZEN';
UPDATE Buildings SET CityRangedStrikeRange = '0' WHERE Type = 'BUILDING_AUSTRIA_STANDSCHUTZEN';
UPDATE Buildings SET CityIndirectFire = '0' WHERE Type = 'BUILDING_AUSTRIA_STANDSCHUTZEN';
UPDATE Buildings SET BlockScienceTheft = '0' WHERE Type = 'BUILDING_AUSTRIA_STANDSCHUTZEN';
...
UPDATE Buildings SET PovertyHappinessChange = '-25' WHERE Type = 'BUILDING_NETHERLANDS_WAAG';
...
UPDATE Buildings SET MinorityHappinessChangeGlobal = '-50' WHERE Type = 'BUILDING_ENGLAND_WHITE_TOWER';
